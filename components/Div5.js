...
export default function Div5() {
    return(
        <section className='bg-black py-20 px-5 flex flex-col lg:flex-row lg:flex-row-reverse 2xl:justify-center font-nunito'>
            {/* CONTENT */}
            <div className='text-white lg:w-[50%] text-center my-auto 2xl:w-[30%] 2xl:mx-0'>
            ...
            {/* IMAGE */}
            <div className='pt-10 lg:pt-5 mx-auto 2xl:mx-0'>
