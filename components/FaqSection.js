...
export default function FaqSection(){
    return(
        <section className="bg-black py-10 font-nunito">
            ...
            {/* FAQ Div */}
            <div className="mx-7 lg:mx-14 my-10 2xl:mx-[17%]">
                <Accordion 
            ...
            <div className='mt-12'>
                <p className='text-white text-center my-3 mx-3 text-md md:text-lg lg:text-xl font-semibold'>Ready to watch? Enter your email to create or restart your membership.</p>

                <div className='flex flex-col md:flex-row gap-x-2 mx-auto justify-center'>
                    <div className='mt-auto w-[70%] md:w-[50%] mx-auto md:mx-0 lg:w-[36%]'>
                    ...
                    <button className='flex text-white bg-[#E50914] rounded-sm mx-auto md:mx-0 mt-4 px-5 py-3 hover:bg-[#E50914]/80 hover:linear hover:duration-200'>
                        <p className='text-lg md:text-2xl font-bold'>Get Started</p>
