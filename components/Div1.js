    ...
    return(
        <div className='h-[40rem] font-nunito'>
            <section className="bg-hero bg-center bg-no-repeat bg-cover h-full p-[1.2rem]">
                ...
                {/* CONTENT */}
                <div className='mt-[23%]'>
                    <p className='font-black text-white text-3xl md:text-5xl text-center'>Unlimited movies, TV shows and more.</p>
                    <p className='text-white text-center mt-5 font-semibold text-lg md:text-2xl'>Watch anywhere. Cancel anytime.</p>
                    <p className='text-white text-center mt-5 mx-3 text-lg md:text-xl'>Ready to watch? Enter your email to create or restart your membership.</p>

                    <div className='flex flex-col md:flex-row gap-x-2 mx-auto justify-center mt-7 md:mt-0'>
                        <div className='mt-auto w-[70%] md:w-[36%] mx-auto md:mx-0'>
                        ...
                        <button className='flex text-white mx-auto md:mx-0 bg-[#E50914] rounded-sm mt-4 px-5 py-3 hover:bg-[#E50914]/80 hover:linear hover:duration-200'>
                            <p className='text-md md:text-2xl font-bold'>Get Started</p>
